...
export default function Signup() {
    ...
    return (
        <div className="min-h-screen bg-slate-950 flex items-center justify-center px-4 relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-1/4 w-96 h-96 bg-emerald-500/5 rounded-full blur-3xl animate-pulse"></div>
            ...
            <div className="w-full max-w-md relative z-10">
                <div className="bg-slate-900 backdrop-blur-xl border border-emerald-500/30 rounded-2xl shadow-2xl shadow-emerald-500/20 p-8">
                    <div className="text-center mb-8">
                        ...
                        <p className="text-slate-400 text-center mt-2">Join our streaming community</p>
                    </div>
